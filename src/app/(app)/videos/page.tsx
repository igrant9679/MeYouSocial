      ...
      <div className="flex items-center gap-3 mb-1.5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-[var(--mute)]">
            ...
            {" "}(<Link href="/admin/api-keys" className="underline">change in Settings → Keys</Link>) ·
      ...
      <div className="card mb-4">
        ...
        {editor && brandedReadiness.ready ? (
          ...
          <p className="text-xs px-2.5 py-1.5 rounded-lg inline-block" style={{ background: "var(--amber-soft)", color: "var(--amber-on)" }}>
            Add a HeyGen key under <Link href="/admin/api-keys" className="underline">Settings → Keys</Link>, or run the app where Chrome is installed for free local rendering.
          </p>
        ) : null}
