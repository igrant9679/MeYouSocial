    ...
    <main className="w-full">
      ...
      {!hasAnyData && (
        <EmptyState
          ...
          note={admin ? "A dash means not measured, never zero. Connecting Search Console and GA4 also needs someone to grant access on Google's side." : "A dash means not measured, never zero. An admin connects the analytics accounts."}
          action={admin ? { label: "Connect analytics", href: "/admin/analytics" } : editor ? { label: "Enter numbers by hand", href: "/blog/analytics" } : null}
        />
      )}
