 ...
 * wordmark where the family name is already visible.
 *
 * Deliberately NOT renamed, because they are contracts: the API token header
 * `X-MeYouSocial-Token`, the Google Drive folder `APP_FOLDER_NAME`, the repo
