...
export const HELP_CATEGORIES: FaqCategory[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      {
        q: "Is there a cost?",
        a: "No. MeYouSocial Publish has no billing, no credits, no payments. AI usage is unmetered for invited members. Admins can optionally set soft monthly limits per user (under Settings → Usage) to bound shared infrastructure cost.",
