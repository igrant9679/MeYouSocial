...
Video studio — a switch on the Settings overview: Scripts, Thumbnails, Videos and Production show under Drafts only when a YouTube channel exists and it is on; nothing is deleted by turning it off.`,
  ...
  },
  {
    ...
    keywords: ["assistant", "you", "can you", "ask", "tool", "help me"],
    body: `I read the workspace (pipeline status, ideas, articles, live web search) and I make things: discover ideas, add an idea, draft an article, generate its SEO and images, draft a social post. Everything I make lands where a person reviews it — an article at review, a post as a draft, images pending. I cannot publish, send, schedule, queue or approve anything, delete anything, or change a setting, key, connection, slot or role — by design, so approving stays the last human act before an audience sees anything. Ask me how to do those and I will name the page. I also know the app's routines and every page; ask "how do I…" or "why is … held".`,
  },
];
